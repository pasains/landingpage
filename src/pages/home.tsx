    ...
    <Layout>
      <div className="font-nunito">
        <div className="pt-[90px] max-w-full justify-items-center mx-auto text-center">
          ...
          <div className="contaier border mt-[50px] p-[25px] md:w-[600px] text-md text-justify mx-auto tracking-wide">
            Selamat datang di situs web resmi PASAINS, wadah bagi para mahasiswa
            dan mahasiswi Fakultas Matematika dan Ilmu Pengetahuan Alam
            Universitas Gadjah Mada yang memiliki semangat tinggi dalam menjaga
            dan menjelajahi keindahan alam.
          </div>
