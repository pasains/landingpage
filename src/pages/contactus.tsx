...
export function ContactUs() {
  return (
    <Layout>
      <RefreshTop />
      <div>
        <section className="bg-forest bg-fixed bg-cover bg-center bg-no-repeat h-full md:h-screen w-screen font-nunito focus:scroll-auto">
          <div className="bg-black bg-opacity-50 h-full md:h-screen w-screen">
            <h1 className="pt-24 text-3xl md:text-4xl text-white text-center tracking-wider font-extrabold mb-5 md:mb-7">
              CONTACT US
            </h1>
            <p className="text-md md:text-lg border border-white md:border-0 text-white text-center mt-4 w-3/4 md:w-1/2 p-2 md:p-0 items-center mx-auto font-light tracking-wider">
            ...
            <div className="flex flex-wrap md:flex-cols mt-10 place-items-center w-full md:w-3/4 mx-auto space-y-10 md:space-y-0">
              <div className=" mx-auto text-left space-y-5 md:space-y-14">
              ...
              <div className="font-nunito items-center mx-auto h-fit w-full md:w-fit bg-white p-6 md:p-8">
                <h1 className="text-xl tracking-tighter font-bold text-bold-orange mb-5">
                  MESSAGE US
                </h1>
                ...
                <div className="mb-5 space-y-2">
                  <h4>Comments</h4>
                  <button className="container border-2 md:w-96 w-80 h-40"></button>
                </div>
